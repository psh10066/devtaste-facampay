...
public record PaymentStoreDTO(Long paymentId, String storeName, BigDecimal money, PaymentStatusType paymentStatus, LocalDateTime createdAt) {
    ...
    public static PaymentStoreDTO of(Long paymentId, String storeName, BigDecimal money, PaymentStatusType paymentStatus, LocalDateTime createdAt) {
